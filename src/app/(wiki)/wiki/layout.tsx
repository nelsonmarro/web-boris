          ...
          <header className="sticky top-6 z-40 flex h-20 shrink-0 items-center gap-2 mx-6 rounded-full glass-liquid border-refractive px-6 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
            <div className="flex items-center gap-2">
               ...
               <div className="flex flex-col group-data-[collapsible=icon]:hidden">
                  <span className="text-[8px] font-black uppercase tracking-[0.3em] text-white/30 leading-none">Terminal</span>
                  <span className="text-[10px] font-black uppercase tracking-[0.1em] text-primary italic leading-tight">Acceso Lore</span>
               </div>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-4 px-6 border-l border-white/10 ml-4">
               <div className="flex flex-col text-right">
                  <span className="text-[8px] font-black uppercase tracking-[0.3em] text-white/20">Status</span>
                  <span className="text-[10px] font-black uppercase tracking-[0.1em] text-green-500/80 animate-pulse">Encriptado</span>
               </div>
