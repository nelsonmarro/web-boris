...
export default function WikiLayout({
  ...
  return (
    <SidebarProvider>
      <BubbleTrail />
      <div className="flex min-h-screen w-full bg-[#0a2339] relative z-0">
        <AppSidebar />
        <SidebarInset className="flex flex-col min-w-0 bg-transparent overflow-hidden">
          <header className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-2 bg-[#061a2e] border-b border-white/5 px-6 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col group-data-[collapsible=icon]:hidden">
                <span className="text-[8px] font-bold uppercase tracking-wider text-white/30 leading-none">
                  Terminal
                </span>
                <span className="text-[10px] font-bold uppercase tracking-[0.1em] text-primary italic leading-tight">
                  Acceso Lore
                </span>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-4 px-6 border-l border-white/10 ml-4">
              <div className="flex flex-col text-right">
                <span className="text-[8px] font-bold uppercase tracking-wider text-white/20">
                  Status
                </span>
                <span className="text-[10px] font-bold uppercase tracking-[0.1em] text-green-500/80 animate-pulse">
                  Encriptado
                </span>
              </div>
