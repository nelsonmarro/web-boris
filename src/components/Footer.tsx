  ...
  return (
    <footer className="relative mt-20 pt-20 pb-10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="glass-liquid rounded-[3rem] p-10 md:p-16 border-white/10 shadow-[0_-20px_50px_rgba(0,0,0,0.3)] relative group">
          {/* Glass Layers */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
            ...
            <div className="space-y-6 lg:col-span-1">
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-2xl font-black tracking-tighter text-white uppercase italic">Borisao<span className="text-primary">Blois</span></span>
              </div>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-white font-black uppercase tracking-widest text-[10px] mb-6">Navegación</h4>
              <ul className="space-y-2">
                {["Inicio", "La Wiki", "Universos", "Versus Arena"].map((link) => (
                  <li key={link}>
                    <Link href="#" className="h-11 flex items-center text-white/50 hover:text-white transition-colors text-xs font-black uppercase tracking-widest">{link}</Link>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* Universes */}
            <div>
              <h4 className="text-white font-black uppercase tracking-widest text-[10px] mb-6">Universos</h4>
              <ul className="space-y-2">
            ...
            <div className="space-y-6">
              <h4 className="text-white font-black uppercase tracking-widest text-xs mb-6">Contacto Oficial</h4>
              <a href="mailto:borisaoblois343@gmail.com" className="flex items-center gap-3 text-white/80 hover:text-primary transition-colors group">
                ...
                <span className="text-sm font-black tracking-tight">borisaoblois343@gmail.com</span>
              </a>
              <div className="pt-4">
                 <p className="text-[10px] text-white/30 uppercase font-black tracking-[0.2em]">Soporte Técnico</p>
          ...
          <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
             ...
             <div className="flex gap-8">
               <a href="#" className="text-[10px] text-white/20 hover:text-white transition-colors uppercase font-black tracking-widest">Privacidad</a>
               <a href="#" className="text-[10px] text-white/20 hover:text-white transition-colors uppercase font-black tracking-widest">Términos</a>
             </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-64 bg-primary/10 blur-[120px] -z-10 rounded-full" />
    </footer>
  );
}
