...
export function WikiBanner({ label, title, gradientTitle, description }: WikiBannerProps) {
  return (
    <section className="relative glass-liquid bg-black/30 rounded-[3rem] p-10 md:p-16 border-white/10 shadow-[0_40px_80px_rgba(0,0,0,0.6)] overflow-hidden group border-refractive">
      ...
      <div className="relative z-10 max-w-4xl space-y-8">
        <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 border border-white/10 text-white/90 text-[10px] font-bold uppercase tracking-wider backdrop-blur-md">
