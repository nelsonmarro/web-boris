  ...
  return (
    <div className={cn("relative group w-full", className)}>
      ...
      <Input
        ...
        className={cn(
          "h-16 pl-14 pr-12 bg-white/5 border-white/10 rounded-[1.5rem] focus:border-primary/40 focus:ring-primary/20 transition-all font-bold text-white placeholder:text-white/20 text-lg shadow-[inset_0_2px_4px_rgba(255,255,255,0.05)] focus:shadow-[0_0_30px_rgba(255,115,0,0.1)]",
          inputClassName
        )}
      />
