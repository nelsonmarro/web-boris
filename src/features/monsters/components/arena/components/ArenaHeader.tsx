    ...
    <header className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-16">
      <div className="space-y-4">
         <div className="inline-flex items-center gap-2.5 px-4 py-1.5 glass-liquid rounded-full border-white/10 bg-white/5">
            ...
            <span className="text-white text-[10px] font-black tracking-[0.2em] uppercase">{subtitle}</span>
         </div>
      ...
      <div className="flex items-center gap-4">
        <Button variant="outline" className="h-14 px-8 rounded-2xl glass-liquid border-white/10 text-white font-black uppercase tracking-widest text-[11px] italic">
           Reglas de la Arena
        </Button>
      </div>
    </header>
