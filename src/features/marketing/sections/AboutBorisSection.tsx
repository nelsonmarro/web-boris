        ...
        <div className="glass-liquid rounded-[4rem] border-white/10 shadow-[0_40px_100px_rgba(0,0,0,0.6)] overflow-hidden relative group">
          ...
          <div className="flex flex-col lg:flex-row items-stretch">
            ...
            <div className="w-full lg:w-1/2 relative min-h-[400px] lg:min-h-0 overflow-hidden border-b lg:border-b-0 lg:border-r border-white/10">
               <Image 
                 src="/assets/Universo Capitán de Galeón/Borisao 2 F (1).png" 
               ...
               <div className="absolute top-10 left-10 inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-white/5 backdrop-blur-3xl border border-white/20 shadow-2xl">
                  ...
                  <span className="text-[10px] font-black text-white uppercase tracking-[0.2em]">Señal de Origen</span>
               </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 p-10 md:p-20 flex flex-col justify-center space-y-10 relative z-10">
               <div className="space-y-6">
                  <div className="inline-flex items-center gap-3 text-primary">
                     ...
                     <span className="text-[11px] font-black uppercase tracking-[0.4em]">El Arquitecto del Lore</span>
                  </div>
                  ...
                  <p className="text-xl text-white/60 font-medium leading-relaxed">
                    Creador de contenido, narrador de misterios y guardián de los archivos abisales. Mi misión es documentar lo inexplicable y dar voz a las criaturas que habitan en la penumbra de nuestra imaginación.
                  </p>
               </div>

               <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                     <p className="text-[9px] font-black text-white/30 uppercase tracking-widest">Comunidad</p>
                     <p className="text-3xl font-black text-white italic tracking-tight uppercase">+2M Exploradores</p>
                  </div>
                  <div className="space-y-2">
                     <p className="text-[9px] font-black text-white/30 uppercase tracking-widest">Contenido</p>
                     <p className="text-3xl font-black text-white italic tracking-tight uppercase">Lore Original</p>
                  </div>
               </div>

               <div className="flex flex-wrap gap-4 pt-6">
                  <SocialLink icon={<Video className="w-5 h-5" />} href="#" color="hover:bg-red-600/20 hover:text-red-500" />
                  <SocialLink icon={<Camera className="w-5 h-5" />} href="#" color="hover:bg-pink-600/20 hover:text-pink-500" />
                  <SocialLink icon={<Send className="w-5 h-5" />} href="#" color="hover:bg-blue-400/20 hover:text-blue-400" />
                  <SocialLink icon={<MessageCircle className="w-5 h-5" />} href="#" color="hover:bg-indigo-600/20 hover:text-indigo-400" />
               </div>

               {/* Boris Personal Signature Style Badge */}
               <div className="pt-8 border-t border-white/5 opacity-40">
                  <p className="text-[8px] font-black uppercase tracking-[0.5em] text-white">Documentación Autorizada // Código 343-B</p>
               </div>
            </div>
          </div>
        </div>
